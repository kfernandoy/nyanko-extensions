...
"""Adaptador de ManhwasMe: buscador unico y rutas heredadas de TuManhwas."""

_MANHWASME_DATE = re.compile(r"(\d{1,2})/(\d{1,2})/(\d{2})")
_MANHWASME_NUMBER = re.compile(r"\d+(?:\.\d+)?")
_MANHWASME_UNITS = (
    (("segundo",), "seconds"), (("minuto",), "minutes"), (("hora",), "hours"),
    (("día", "dia"), "days"), (("semana",), "weeks"),
)
_MANHWASME_GENRES = (
    ("academia", "Academia"), ("accion", "Accion"), ("amigos-con-derechos", "Amigos con derechos"),
    ("amigos-de-la-infancia", "Amigos de la infancia"), ("apocaliptico", "Apocaliptico"),
    ("artes-marciales", "Artes Marciales"), ("av", "AV"), ("aventura", "Aventura"),
    ("boys-love", "Boys Love"), ("ciencia-ficcion", "Ciencia Ficción"), ("comedia", "Comedia"),
    ("cultivo", "Cultivo"), ("drama", "Drama"), ("ecchi", "Ecchi"), ("ejercito", "Ejercito"),
    ("fantasia", "Fantasia"), ("girls-love", "Girls love"), ("gore", "Gore"), ("harem", "Harem"),
    ("historias-cortas", "Historias cortas"), ("hombres-lobo", "Hombres lobo"), ("horror", "Horror"),
    ("intercambio-de-parejas", "Intercambio de parejas"), ("isekai", "Isekai"), ("josei", "Josei"),
    ("madrastra", "Madrastra"), ("madre-e-hija", "Madre e hija"), ("magia", "Magia"),
    ("milf", "Milf"), ("misterio", "Misterio"), ("mujer-casada", "Mujer casada"),
    ("mujer-mayor", "Mujer mayor"), ("ntr", "NTR"), ("pareja-casada", "Pareja casada"),
    ("primer-amor", "Primer amor"), ("psicologico", "Psicológico"), ("rape", "Rape"),
    ("realidad-virtual", "Realidad virtual"), ("recuentos-de-la-vida", "Recuentos de la vida"),
    ("reencarnacion", "Reencarnacion"), ("relacion-secreta", "Relacion secreta"),
    ("romance", "Romance"), ("sistema-de-niveles", "Sistema de Niveles"),
    ("sobrenatural", "Sobrenatural"), ("superpoderes", "Superpoderes"), ("thriller", "Thriller"),
    ("tragedia", "Tragedia"), ("universidad", "Universidad"), ("vampiros", "Vampiros"),
    ("venganza", "Venganza"),
)
...
class ManhwasMeSource(MadaraSource):
...
SOURCE = GeneratedManhwasMeSource
