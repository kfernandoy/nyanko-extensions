...
class GeneratedGenericSource(GenericSource):
        ...
        data = [
                {
                                ...
                                "options": [
                                                ...
                                                },
                                                {
                                                                ...
                                                                "value": "Cheating/Infidelity"
                                                },
                                                {
                                                                "name": "Childhood Friends",
                                                                "value": "Childhood Friends"
                                                },
                                                {
                                                                "name": "College life",
                                                                "value": "College life"
                                                ...
                                                {
                                                                "name": "Emperor's daughte",
                                                                "value": "Emperor's daughte"
                                                },
                                                {
                                                                "name": "Fantasy",
                                                                "value": "Fantasy"
    ...
    name = 'comicaso_id'
    display_name = 'Comicaso'
    base_url = 'https://v3.comicaso.pro'
    language = 'id'
