...
"""Adaptador de Rncalation: biblioteca filtrable y capitulos por endpoint propio."""

_NARTAG_DIGITS = re.compile(r"\d+")
_NARTAG_ABSOLUTE = re.compile(r"([A-Za-z]{3})\w*\s+(\d{1,2}),\s*(\d{4})")
_NARTAG_MONTHS = {
    "jan": 1, "feb": 2, "mar": 3, "apr": 4, "may": 5, "jun": 6,
    "jul": 7, "aug": 8, "sep": 9, "oct": 10, "nov": 11, "dec": 12,
}
_NARTAG_STATUS_WORDS = ("emisión", "completado", "pausa", "cancelado")
_NARTAG_SORT = (
    ("latest", "Más reciente"), ("updated", "Actualizado"), ("views", "Más visto"),
    ("rating", "Mejor valorado"), ("title", "A-Z"),
)
_NARTAG_GENRES = (
    "Acción", "Adventure", "Aventura", "ciencia ficción", "Comedia", "Cultivación",
    "Drama", "Fantasia", "Fantasía", "Harem", "Love", "Manhua", "Reencarnacion",
    "Romance", "Sistema", "Supernatural", "+15",
)
...
class RncalationSource(MadaraSource):
...
SOURCE = GeneratedRncalationSource
