...
"""Adaptador de RavenManga: catalogos embebidos y lector tras un formulario."""

_RAVEN_PROJECTS = re.compile(r"proyectos\s*=\s*(\[[\s\S]+?\])\s*;")
_RAVEN_NUMBER = re.compile(r"(\d+)")
_RAVEN_UNITS = (
    (("segundo",), "seconds"),
    (("minuto",), "minutes"),
    (("hora",), "hours"),
...
class RavenMangaSource(MadaraSource):
