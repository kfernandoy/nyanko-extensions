...
class GeneratedGenericSource(GenericSource):
    name = 'ainzscansid_id'
    display_name = 'Ainz Scans ID'
    base_url = 'https://v2.ainzscans01.com'
    api_url = 'https://api.ainzscans01.com/api'
    language = 'id'
        ...
        return [
            SourceFilter(
                ...
                options=[
                    ...
                    {"value": "views", "name": "Top Views"},
                    {"value": "rate", "name": "Top Rating"},
                    {"value": "bookmark", "name": "Top Bookmark"},
                    {"value": "az", "name": "Title A-Z"},
                    {"value": "za", "name": "Title Z-A"},
                ],
                default="latest"
            ),
            SourceFilter(
            ...
            SourceFilter(
                ...
                options=[
                    ...
                    {"value": "gender-bender", "name": "Gender Bender"},
            ...
            SourceFilter(
                ...
                options=[
                    {"value": "", "name": "All"},
                    {"value": "FULL_COLOR", "name": "Full Color"},
                    {"value": "BW", "name": "B&W"},
                ],
                default=""
            ),
            SourceFilter(
                ...
                options=[
                    {"value": "", "name": "All"},
                    {"value": "VERTICAL_SCROLL", "name": "Vertical Scroll"},
                    {"value": "PAGE", "name": "Page"},
                ],
                default=""
            ),
            SourceFilter(type="text", id="author", name="Author"),
            SourceFilter(type="text", id="artist", name="Artist"),
            SourceFilter(type="text", id="publisher", name="Publisher"),
        ]

    async def search(
        self, query: str, filters: dict | None = None, page: int = 1
    ) -> list[SourceSeries] | dict:
        filters = filters or {}
        params = {
            "type": "COMIC",
            "limit": "20",
