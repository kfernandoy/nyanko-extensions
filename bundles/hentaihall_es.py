...
class GeneratedHentaiHallSource(HentaiHallSource):
    name = 'hentaihall_es'
    display_name = 'HentaiHall'
    base_url = 'https://hentaihall.com'
    language = 'es'
    requests_per_minute = 60
    genres = ('Anal', 'Ahegao', 'Bbw', 'Bestiality', 'Big Ass', 'Big Boobs', 'Bisexual', 'Blowjob', 'Bondage', 'Bukkake', 'Cheating', 'Comedy', 'Colour', 'Creampie', 'Dark Skin', 'Deepthroat', 'Double Penetration', 'Domination', 'Exhibitionism', 'Fantasy', 'Femdom', 'Fetish', 'Ffm Threesome', 'Filming', 'FootJob', 'Forced', 'Furry', 'Futanari', 'Group', 'Gyaru', 'Harem', 'Horror', 'Humiliation', 'Impregnation', 'Incest', 'Kissing', 'Loli', 'Mature', 'Milf', 'Mmf Threesome', 'Mother', 'Monsters', 'Netorare', 'Netorase', 'Nympho', 'Orgy', 'Oyakodon', 'Parody', 'Pregnant', 'Rape', 'Romance', 'Shota', 'Small Boobs', 'Sole Female', 'Sole Male', 'Sport', 'Student', 'Tall Girl', 'Tentacles', 'Tomboy', 'Toys', 'Tsundere', 'Uncensored', 'Virgin', 'Yandere', 'Yaoi', 'Yuri', '3D')
