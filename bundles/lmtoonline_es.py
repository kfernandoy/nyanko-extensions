...
class GeneratedGenericSource(LmtosSource):
    name = 'lmtoonline_es'
    display_name = 'Lmtos'
    ...
    genre_options = (('Acción', 'Acción'), ('Artes Marciales', 'Artes Marciales'), ('Aventuras', 'Aventuras'), ('Carreras', 'Carreras'), ('Ciencia Ficción', 'Ciencia Ficción'), ('Comedia', 'Comedia'), ('Demencia', 'Demencia'), ('Demonios', 'Demonios'), ('Deportes', 'Deportes'), ('Drama', 'Drama'), ('Ecchi', 'Ecchi'), ('Escolares', 'Escolares'), ('Gore', 'Gore'), ('Harem', 'Harem'), ('Isekai', 'Isekai'), ('Juegos', 'Juegos'), ('Magia', 'Magia'), ('Mecha', 'Mecha'), ('Militar', 'Militar'), ('Misterio', 'Misterio'), ('Música', 'Música'), ('Parodia', 'Parodia'), ('Policía', 'Policía'), ('Psicológico', 'Psicológico'), ('Recuentos de la vida', 'Recuentos de la vida'), ('Romance', 'Romance'), ('Romcom', 'Romcom'), ('Samurai', 'Samurai'), ('Sobrenatural', 'Sobrenatural'), ('Superpoderes', 'Superpoderes'), ('Suspenso', 'Suspenso'), ('Terror', 'Terror'), ('Vampiros', 'Vampiros'), ('Yaoi', 'Yaoi'), ('Yuri', 'Yuri'))
    status_options = (('', 'Todos'), ('ongoing', 'En emisión'), ('completed', 'Finalizado'), ('paused', 'Pausado'))
    demographic_options = (('', 'Todos'), ('shounen', 'Shounen'), ('shoujo', 'Shoujo'), ('seinen', 'Seinen'), ('josei', 'Josei'))
    type_options = (('', 'Todos'), ('manga', 'Manga'), ('manhua', 'Manhua'), ('oneshot', 'One-shot'))
    nsfw_options = (('', 'Todos'), ('hide', 'Sin +18'), ('only', 'Solo +18'))
    order_options = (('a-z', 'A-Z'), ('recents', 'Más recientes'), ('views', 'Mejor valorados'))
