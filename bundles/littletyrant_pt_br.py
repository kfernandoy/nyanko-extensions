...
class GeneratedMadaraSource(MadaraSource):
    name = 'littletyrant_pt_br'
    display_name = 'Little Tyrant'
    base_url = 'https://tiraninha.world'
    language = 'pt-BR'
    manga_substring = 'manga'
    load_more = 'never'
    use_new_chapter_endpoint = False
    ...
    pages_profile = 'base64_pages'
    extra_headers = {}
    image_headers = {'Accept': 'image/webp,image/*,*/*', 'Referer': 'https://tiraninha.world/', 'X-Reader-Sec': 'tiraninha-web'}
