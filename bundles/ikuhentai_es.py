...
class GeneratedGenericSource(IkuhentaiSource):
    name = 'ikuhentai_es'
    display_name = 'Ikuhentai'
    base_url = 'https://ikuhentai.net'
    language = 'es'
    requests_per_minute = 60
    content_warning = 'nsfw'
    sort_options = (('', 'Relevance'), ('latest', 'Latest'), ('alphabet', 'A-Z'), ('rating', 'Calificación'), ('trending', 'Tendencia'), ('views', 'Más visto'), ('new-manga', 'Nuevo'))
    status_options = (('end', 'Completado'), ('on-going', 'En emisión'), ('canceled', 'Cancelado'), ('on-hold', 'Pausado'))
    genre_options = (('ahegao', 'Ahegao'), ('anal', 'Anal'), ('bestialidad', 'Bestiality'), ('bondage', 'Bondage'), ('bukkake', 'Bukkake'), ('chicas-monstruo', 'Chicas monstruo'), ('chikan', 'Chikan'), ('colegialas', 'Colegialas'), ('comics-porno', 'Comics porno'), ('dark-skin', 'Dark Skin'), ('demonios', 'Demonios'), ('ecchi', 'Ecchi'), ('embarazadas', 'Embarazadas'), ('enfermeras', 'Enfermeras'), ('eroges', 'Eroges'), ('fantasia', 'Fantasía'), ('futanari', 'Futanari'), ('gangbang', 'Gangbang'), ('gemelas', 'Gemelas'), ('gender-bender', 'Gender Bender'), ('gore', 'Gore'), ('handjob', 'Handjob'), ('harem', 'Harem'), ('hipnosis', 'Hipnosis'), ('incesto', 'Incesto'), ('loli', 'Loli'), ('maids', 'Maids'), ('masturbacion', 'Masturbación'), ('milf', 'Milf'), ('mind-break', 'Mind Break'), ('my-hero-academia', 'My Hero Academia'), ('naruto', 'Naruto'), ('netorare', 'Netorare'), ('paizuri', 'Paizuri'), ('pokemon', 'Pokemon'), ('profesora', 'Profesora'), ('prostitucion', 'Prostitución'), ('romance', 'Romance'), ('straight-shota', 'Straight Shota'), ('tentaculos', 'Tentáculos'), ('virgen', 'Virgen'), ('yaoi', 'Yaoi'), ('yuri', 'Yuri'))
