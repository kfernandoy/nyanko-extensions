...
class GeneratedMangaThemesiaSource(MangaThemesiaSource):
    name = 'starlightscan_pt_br'
    display_name = 'Starlight Scan'
    base_url = 'https://starligthscan.com'
    language = 'pt-BR'
    manga_directory = '/mangas'
    reader_id = 'readerarea'
    supports_latest = True
    requests_per_minute = 60
    image_no_referer_hosts = ()
    search_profile = 'starlight'
    browse_profile = 'default'
    chapter_profile = 'default'
    pages_profile = 'default'
    reader_class = 'scanImagesContainer'
    image_class = 'scanImage'
