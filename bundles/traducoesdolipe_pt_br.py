...
class GeneratedZeistMangaSource(ZeistMangaSource):
    name = 'traducoesdolipe_pt_br'
    display_name = 'Traduções do Lipe'
    base_url = 'https://traducoesdolipe.blogspot.com'
    language = 'pt-BR'
    manga_category = 'Projeto'
    chapter_category = 'Capítulo'
    use_new_chapter_feed = False
    chapter_feed_profile = 'cat_name'
