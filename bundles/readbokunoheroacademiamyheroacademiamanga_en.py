...
class GeneratedMangaCatalogSource(MangaCatalogSource):
    name = 'readbokunoheroacademiamyheroacademiamanga_en'
    display_name = 'Read Boku no Hero Academia My Hero Academia Manga'
    base_url = 'https://ww10.readmha.com'
    language = 'en'
    source_list = (('Boku no Hero Academia', 'https://ww10.readmha.com/manga/boku-no-hero-academia/'), ('Vigilante', 'https://ww10.readmha.com/manga/vigilante-boku-no-hero-academia-illegals/'), ('Team Up', 'https://ww10.readmha.com/manga/my-hero-academia-team-up-mission/'), ('MHA Smash', 'https://ww10.readmha.com/manga/boku-no-hero-academia-smash/'), ('School Brief', 'https://ww10.readmha.com/manga/my-hero-academia-school-briefs/'), ('Rising', 'https://ww10.readmha.com/manga/deku-bakugo-rising/'), ('Colored', 'https://ww10.readmha.com/manga/boku-no-hero-academia-colored/'), ('Oumagadoki Zoo', 'https://ww10.readmha.com/manga/oumagadoki-zoo/'), ('Sensei no Bulge', 'https://ww10.readmha.com/manga/sensei-no-bulge/'), ('Ultra Analysis', 'https://ww10.readmha.com/manga/my-hero-academia-ultra-analysis/'))
