...
class GeneratedHeavenMangaSource(HeavenMangaSource):
    ...
    language = 'es'
    requests_per_minute = 60
    genre_options = (('<Seleccionar>', ''), ('Accion', 'accion'), ('Adulto', 'adulto'), ('Artes Marciales', 'artes-marciales'), ('Acontesimientos de la Vida', 'acontesimientos-de-la-vida'), ('Bakunyuu', 'bakunyuu'), ('Gore', 'gore'), ('Gender Bender', 'gender-bender'), ('Humor', 'humor'), ('Harem', 'harem'), ('Hentai', 'hentai'), ('Horror', 'horror'), ('Historico', 'historico'), ('Josei', 'josei'), ('Loli', 'loli'), ('Light', 'light'), ('Lucha Libre', 'lucha-libre'), ('Manga', 'manga'), ('Mecha', 'mecha'), ('Magia', 'magia'), ('Manhwa', 'manhwa'), ('Manhua', 'manhua'), ('Mature', 'mature'), ('Misterio', 'misterio'), ('Mutantes', 'mutantes'), ('Novela', 'novela'), ('OneShot', 'oneshot'), ('Psicologico', 'psicologico'), ('Romance', 'romance'), ('Recuentos de la vida', 'recuentos-de-la-vida'), ('Smut', 'smut'), ('Shojo', 'shojo'), ('Shonen', 'shonen'), ('Seinen', 'seinen'), ('Shoujo', 'shoujo'), ('Shounen', 'shounen'), ('Suspenso', 'suspenso'), ('School Life', 'school-life'), ('SuperHeroes', 'superheroes'), ('Supernatural', 'supernatural'), ('Slice of Life', 'slice-of-life'), ('Super Poderes', 'super-poderes'), ('Torneo', 'torneo'), ('Tragedia', 'tragedia'), ('Transexual', 'transexual'), ('Vampiros', 'vampiros'), ('Violencia', 'violencia'), ('Vida Pasadas', 'vida-pasadas'), ('Vida Cotidiana', 'vida-cotidiana'), ('Vida de Escuela', 'vida-de-escuela'), ('Webtoon', 'webtoon'), ('Yaoi', 'yaoi'), ('Yuri', 'yuri'), ('Sobrenatural', 'sobrenatural'), ('Drama', 'drama'), ('Ecchi', 'ecchi'), ('Comedia', 'comedia'), ('Aventura', 'aventura'), ('Fantasia', 'fantasia'), ('Demonios', 'demonios'), ('Superpoderes', 'superpoderes'), ('Deporte', 'deporte'), ('Ciencia Ficcion', 'ciencia-ficcion'), ('Supervivencia', 'supervivencia'), ('Crimen', 'crimen'), ('Reencarnación', 'reencarnacion'), ('Género Bender', 'genero-bender'), ('Apocaliptico', 'apocaliptico'), ('Familia', 'familia'), ('Militar', 'militar'), ('Guerra', 'guerra'), ('Realidad', 'realidad'), ('Animación', 'animacion'), ('Musica', 'musica'), ('Samurái', 'samurai'), ('Historia', 'historia'), ('Thriller', 'thriller'), ('Girls Love', 'girls-love'), ('Zombies', 'zombies'), ('Netorare', 'netorare'), ('Boys Love', 'boys-love'), ('Transmigración', 'transmigracion'), ('Regresion', 'regresion'), ('Harem Inverso', 'harem-inverso'), ('Moderno', 'moderno'), ('Sistema', 'sistema'), ('Venganza', 'venganza'), ('Amateur', 'amateur'), ('Parodia', 'parodia'), ('Matrimonio', 'matrimonio'))
    alphabet_options = (('<Seleccionar>', ''), ('Other', 'Other'), ('A', 'a'), ('B', 'b'), ('C', 'c'), ('D', 'd'), ('E', 'e'), ('F', 'f'), ('G', 'g'), ('H', 'h'), ('I', 'i'), ('J', 'j'), ('K', 'k'), ('L', 'l'), ('M', 'm'), ('N', 'n'), ('O', 'o'), ('P', 'p'), ('Q', 'q'), ('R', 'r'), ('S', 's'), ('T', 't'), ('U', 'u'), ('V', 'v'), ('W', 'w'), ('X', 'x'), ('Y', 'y'), ('Z', 'z'), ('0-9', '0-9'))
    list_options = (('<Seleccionar>', ''), ('Lista Comis', 'comic'), ('Lista Novelas', 'novela'), ('Lista Adulto', 'adulto'))
