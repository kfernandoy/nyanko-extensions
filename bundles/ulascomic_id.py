...
class GeneratedZeistMangaSource(ZeistMangaSource):
    name = 'ulascomic_id'
    display_name = 'Ulas Comic'
    base_url = 'https://www.ulascomic01.xyz'
    language = 'id'
    manga_category = 'Series'
    chapter_category = 'Manga Chapter'
    use_new_chapter_feed = False
    chapter_feed_profile = 'title'
    popular_is_latest = False
    popular_profile = 'serieslist'
    request_referer = ''
    search_profile = 'default'
    chapter_profile = 'default'
    chapter_categories = ()
    use_old_chapter_feed = False
    pages_profile = 'ulas_script'
    latest_order = 'updated'
    strip_series_query = False
    supports_latest = True
    requests_per_minute = 60
    has_filters = True
