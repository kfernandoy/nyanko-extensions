...
class GeneratedGenericSource(MangaOniSource):
    name = 'mangamx_es'
    ...
    status_options = (('false', 'Estado'), ('1', 'En desarrollo'), ('0', 'Completo'))
    type_options = (('false', 'Todo'), ('0', 'Mangas'), ('1', 'Manhwas'), ('2', 'One Shot'), ('3', 'Manhuas'), ('4', 'Novelas'))
    genre_options = (('false', 'Todos'), ('1', 'Comedia'), ('2', 'Drama'), ('3', 'Acción'), ('4', 'Escolar'), ('5', 'Romance'), ('6', 'Ecchi'), ('7', 'Aventura'), ('8', 'Shōnen'), ('9', 'Shōjo'), ('10', 'Deportes'), ('11', 'Psicológico'), ('12', 'Fantasía'), ('13', 'Mecha'), ('14', 'Gore'), ('15', 'Yaoi'), ('16', 'Yuri'), ('17', 'Misterio'), ('18', 'Sobrenatural'), ('19', 'Seinen'), ('20', 'Ficción'), ('21', 'Harem'), ('25', 'Webtoon'), ('27', 'Histórico'), ('30', 'Músical'), ('31', 'Ciencia ficción'), ('32', 'Shōjo-ai'), ('33', 'Josei'), ('34', 'Magia'), ('35', 'Artes Marciales'), ('36', 'Horror'), ('37', 'Demonios'), ('38', 'Supervivencia'), ('39', 'Recuentos de la vida'), ('40', 'Shōnen ai'), ('41', 'Militar'), ('42', 'Eroge'), ('43', 'Isekai'))
