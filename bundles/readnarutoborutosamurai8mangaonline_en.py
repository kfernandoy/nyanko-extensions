...
class GeneratedMangaCatalogSource(MangaCatalogSource):
    name = 'readnarutoborutosamurai8mangaonline_en'
    display_name = 'Read Naruto Boruto Samurai 8 Manga Online'
    base_url = 'https://ww11.readnaruto.com'
    language = 'en'
    source_list = (('Boruto - Two Blue Vortex', 'https://ww11.readnaruto.com/manga/boruto-two-blue-vortex/'), ('Naruto', 'https://ww11.readnaruto.com/manga/naruto/'), ('Naruto Colored', 'https://ww11.readnaruto.com/manga/naruto-digital-colored-comics/'), ('Naruto Gaiden', 'https://ww11.readnaruto.com/manga/naruto-gaiden-the-seventh-hokage/'), ('Boruto', 'https://ww11.readnaruto.com/manga/boruto-naruto-next-generations/'), ('Samurai 8', 'https://ww11.readnaruto.com/manga/samurai-8-hachimaru-den/'), ('Rock Lee SpinOff', 'https://ww11.readnaruto.com/manga/rock-lee-no-seishun-full-power-ninden/'), ('Chibi Sasuke', 'https://ww11.readnaruto.com/manga/uchiha-sasuke-no-sharingan-den/'), ('Sasuke Story', 'https://ww11.readnaruto.com/manga/naruto-sasuke-retsuden-uchiha-no-matsuei-to-tenkyuu-no-hoshikuzu/'))
