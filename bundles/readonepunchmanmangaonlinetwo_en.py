...
class GeneratedMangaCatalogSource(MangaCatalogSource):
    name = 'readonepunchmanmangaonlinetwo_en'
    display_name = 'Read One-Punch Man Manga Online'
    base_url = 'https://ww6.readopm.com'
    language = 'en'
    source_list = (('One Punch Man', 'https://ww6.readopm.com/manga/one-punch-man/'), ('Official', 'https://ww6.readopm.com/manga/one-punch-man-official/'), ('Onepunch-Man (ONE)', 'https://ww6.readopm.com/manga/onepunch-man-one/'), ('Colored', 'https://ww6.readopm.com/manga/one-punch-man-colored/'), ('Mob Psycho 100', 'https://ww6.readopm.com/manga/mob-psycho-100/'), ('Reigen', 'https://ww6.readopm.com/manga/reigen/'), ('Versus (ONE)', 'https://ww6.readopm.com/manga/versus/'), ('Bug Ego', 'https://ww6.readopm.com/manga/bug-ego/'), ('Eyeshield 21', 'https://ww6.readopm.com/manga/eyeshield-21/'))
