...
class GeneratedMangaCatalogSource(MangaCatalogSource):
    name = 'readberserkmanga_en'
    display_name = 'Read Berserk Manga'
    base_url = 'https://readberserk.com'
    language = 'en'
    source_list = (('Berserk', 'https://readberserk.com/manga/berserk/'), ('Guidebook', 'https://readberserk.com/manga/berserk-official-guidebook/'), ('Colored', 'https://readberserk.com/manga/berserk-colored/'), ('Duranki', 'https://readberserk.com/manga/duranki/'), ('Gigantomakhia', 'https://readberserk.com/manga/gigantomakhia/'), ('Futatabi', 'https://readberserk.com/manga/futatabi/'), ('Berserk Spoilers & RAW', 'https://readberserk.com/manga/berserk-spoilers-raw/'))
