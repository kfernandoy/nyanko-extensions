...
class GeneratedGenericSource (GenericSource ):
    ...
    # Autogenerated via heuristic port
        ...
        {
        "name":"Recent Updated Manga",
        "value":"recent"
        },
        {
        "name":"Editors' Choices",
        "value":"editor-pick"
        },
        {
        "name":"Completed Comedy Manga",
        "value":"completed-comedy-manga"
        },
        {
        "name":"Completed Drama Manga",
        "value":"completed-drama-manga"
        },
        {
        "name":"Completed Fantasy Manga",
        "value":"completed-fantasy-manga"
        },
        {
        "name":"Completed Romance Manga",
        "value":"completed-romance-manga"
        },
        {
        "name":"Action",
        "value":"action"
    ...
    name ='todaymanga_en'
    display_name ='TodayManga'
    base_url ='https://todaymanga.com'
    language ='en'
