...
class GeneratedZeistMangaSource(ZeistMangaSource):
    name = 'gistamishouse_es'
    display_name = 'Gistamis House'
    base_url = 'https://gistamishousefansub.blogspot.com'
    language = 'es'
    manga_category = 'Series'
    chapter_category = ''
    ...
    chapter_feed_profile = 'default'
    popular_is_latest = False
    popular_profile = 'gistamis'
    request_referer = ''
    search_profile = 'default'
    chapter_profile = 'default'
    chapter_categories = ('Capitulo', 'Cap')
    use_old_chapter_feed = False
    pages_profile = 'article_images'
    latest_order = 'published'
    strip_series_query = False
    supports_latest = True
    ...
    excluded_categories = ('Anime', 'Novela')
    status_filters = (('Activo', 'Activo'), ('Completo', 'Completo'), ('Cancelado', 'Cancelado'), ('Futuro', 'Futuro'), ('Pausado', 'Pausado'))
    type_filters = (('Manga', 'Manga'), ('Manhua', 'Manhua'), ('Manhwa', 'Manhwa'))
    genre_filters = (('Acción', 'Acción'), ('Aventura', 'Aventura'), ('Comedia', 'Comedia'), ('Dementia', 'Dementia'), ('Demonios', 'Demonios'), ('Drama', 'Drama'), ('Ecchi', 'Ecchi'), ('Fantasía', 'Fantasía'), ('Videojuegos', 'Videojuegos'), ('Harem', 'Harem'), ('Histórico', 'Histórico'), ('Horror', 'Horror'), ('Josei', 'Josei'), ('Magia', 'Magia'), ('Arte marcial', 'Arte marcial'), ('Mecha', 'Mecha'), ('Militar', 'Militar'), ('Música', 'Música'), ('Misterio', 'Misterio'), ('Parody', 'Parody'), ('Policia', 'Policia'), ('Filosófico', 'Filosófico'), ('Romance', 'Romance'), ('Samurai', 'Samurai'), ('Escolar', 'Escolar'), ('Sci-Fi', 'Sci-Fi'), ('Seinen', 'Seinen'), ('Shoujo', 'Shoujo'), ('GL', 'GL'), ('BL', 'BL'), ('HET', 'HET'), ('Shounen', 'Shounen'), ('Vida cotidiana', 'Vida cotidiana'), ('Espacio', 'Espacio'), ('Deportes', 'Deportes'), ('Super poderes', 'Super poderes'), ('Sobrenatural', 'Sobrenatural'), ('Thriller', 'Thriller'), ('Vampiro', 'Vampiro'), ('Vida laboral', 'Vida laboral'))
    details_profile = 'gistamis'
