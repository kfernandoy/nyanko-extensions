...
class GeneratedGenericSource(LectorJpgSource):
    name = 'lectorjpg_es'
    display_name = 'LectorJPG'
    base_url = 'https://visorjpg.lat'
    language = 'es'
    requests_per_minute = 180
    content_warning = 'mixed'
    genre_options = (('bdsm', 'BDSM'), ('bebes', 'Bebes'), ('bestias', 'Bestias'), ('bl-sin-censura', 'BL Sin Censura'), ('boys-love', 'Boys Love'), ('che-tenete-un-poco-de-amor-propio', 'Che Tenete Un Poco De Amor Propio'), ('ciencia-ficcion', 'Ciencia Ficción'), ('comedia', 'Comedia'), ('crimen', 'Crimen'), ('del-campo', 'Del Campo'), ('demonios', 'Demonios'), ('deportes', 'Deportes'), ('drama', 'Drama'), ('escolar', 'Escolar'), ('espacial', 'Espacial'), ('fantasia', 'Fantasía'), ('furro', 'Furro'), ('harem', 'Harem'), ('harem-inverso', 'Harem Inverso'), ('historia', 'Historia'), ('josei', 'Josei'), ('juego', 'Juego'), ('mafia', 'Mafia'), ('magia', 'Magia'), ('manhwa-19', 'Manhwa +19'), ('militar', 'Militar'), ('moderno', 'Moderno'), ('morocho-hermoso', 'Morocho Hermoso'), ('mucho-gogogo', 'Mucho Gogogo'), ('musica', 'Música'), ('novela', 'Novela'), ('odio-amor', 'Odio-Amor'), ('omegaverse', 'Omegaverse'), ('psicologico', 'Psicológico'), ('reencarnacion', 'Reencarnación'), ('relacion-por-convivencia', 'Relación Por Convivencia'), ('romance', 'Romance'), ('smut', 'Smut'), ('telenovela', 'Telenovela'), ('teton', 'Tetón'), ('toxicidad', 'Toxicidad'), ('toxicidad-nivel-chernobil', 'Toxicidad Nivel Chernóbil'), ('universitario', 'Universitario'), ('venganza', 'Venganza'), ('Shoujo', 'Shoujo'), ('Shounen', 'Shounen'), ('Seinen', 'Seinen'), ('+ 18 Sin Censura', '+18 Sin Censura'), ('nobl', 'NoBL\\uD83D\\uDC8C'), ('gl', 'Girls Love'), ('adulto', 'Adulto'), ('18', '+18'), ('sistema', 'Sistema'), ('puchilovers', 'PuchiLovers'), ('goheart-scan', 'Goheart Scan'), ('Acción', 'Acción'), ('Aventura', 'Aventura'), ('Sobrenatural', 'Sobrenatural'), ('Transmigración', 'Transmigración'))
