...
class GeneratedMangaCatalogSource(MangaCatalogSource):
    name = 'readblackclovermangaonline_en'
    display_name = 'Read Black Clover Manga Online'
    base_url = 'https://ww10.readblackclover.com'
    language = 'en'
    source_list = (('Black Clover', 'https://ww10.readblackclover.com/manga/black-clover/'), ('Fan Colored', 'https://ww10.readblackclover.com/manga/black-clover-colored/'), ('Hungry Joker', 'https://ww10.readblackclover.com/manga/hungry-joker/'), ('Gaiden', 'https://ww10.readblackclover.com/manga/black-clover-gaiden-quartet-knights/'))
