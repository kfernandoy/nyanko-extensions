...
class GeneratedMangaCatalogSource(MangaCatalogSource):
    name = 'readfairytailedenszeromangaonline_en'
    display_name = 'Read Fairy Tail & Edens Zero Manga Online'
    base_url = 'https://ww8.readfairytail.com'
    language = 'en'
    source_list = (("Eden's Zero", 'https://ww8.readfairytail.com/manga/edens-zero/'), ('Fairy Tail', 'https://ww8.readfairytail.com/manga/fairy-tail/'), ('FT Zero', 'https://ww8.readfairytail.com/manga/fairy-tail-zero/'), ('FT City Hero', 'https://ww8.readfairytail.com/manga/fairy-tail-city-hero/'), ('Hero’s', 'https://ww8.readfairytail.com/manga/heros/'), ('FT Happy Adv', 'https://ww8.readfairytail.com/manga/fairy-tail-happys-grand-adventure/'), ('FT 100 Year', 'https://ww8.readfairytail.com/manga/fairy-tail-100-years-quest/'), ('FT Ice Trail', 'https://ww8.readfairytail.com/manga/fairy-tail-ice-trail/'), ('FT x Taizai', 'https://ww8.readfairytail.com/manga/fairy-tail-x-nanatsu-no-taizai-christmas-special/'), ('Parasyte x FT', 'https://ww8.readfairytail.com/manga/parasyte-x-fairy-tail/'), ('Gaiden 1', 'https://ww8.readfairytail.com/manga/fairy-tail-gaiden-raigo-issen/'), ('FT x Rave', 'https://ww8.readfairytail.com/manga/fairy-tail-x-rave/'), ('Monster Hunter', 'https://ww8.readfairytail.com/manga/monster-hunter-orage/'), ('Rave Master', 'https://ww8.readfairytail.com/manga/rave-master/'), ('Dead Rock', 'https://ww8.readfairytail.com/manga/dead-rock/'), ('Fairy Girls', 'https://ww8.readfairytail.com/manga/fairy-girls/'), ('Gaiden 4', 'https://ww8.readfairytail.com/manga/fairy-tail-gaiden-raigo-issen/'), ('Gaiden 2', 'https://ww8.readfairytail.com/manga/fairy-tail-gaiden-kengami-no-souryuu/'), ('Gaiden 3', 'https://ww8.readfairytail.com/manga/fairy-tail-gaiden-road-knight/'), ('FT x 7DS', 'https://ww8.readfairytail.com/manga/fairy-tail-x-nanatsu-no-taizai-christmas-special/'))
