...
class GeneratedGenericSource (GenericSource ):
    ...
    # Autogenerated via heuristic port
        ...
        {
        "name":"Horror･Mystery･Suspense",
        "value":"2"
        },
        {
        "name":"Gag･Comedy･Slice-of-Life",
        "value":"3"
        },
        {
        "name":"SF･Fantasy",
    ...
    name ='kmanga_en'
    display_name ='K Manga'
    base_url ='https://kmanga.kodansha.com'
    language ='en'
    requests_per_minute =60 
