...
class GeneratedMangaCatalogSource(MangaCatalogSource):
    name = 'readsololevelingmangamanhwaonline_en'
    display_name = 'Read Solo Leveling Manga Manhwa Online'
    base_url = 'https://ww3.readsololeveling.org'
    language = 'en'
    source_list = (('Solo Leveling Manhwa', 'https://ww3.readsololeveling.org/manga/solo-leveling/'), ('Solo Leveling Light Novel', 'https://ww3.readsololeveling.org/manga/solo-leveling-light-novel/'), ('Solo Leveling : Ragnarok', 'https://ww3.readsololeveling.org/manga/solo-leveling-ragnarok/'), ('SL: Ragnarok Novel', 'https://ww3.readsololeveling.org/manga/solo-leveling-ragnarok-novel/'))
